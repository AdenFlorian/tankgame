...
/*SF_DATA;ver:1.03;sub:START;pass:START;ps:flbk:,lico:1,lgpr:1,nrmq:1,limd:0,uamb:True,mssp:True,lmpd:False,lprd:False,rprd:False,enco:False,frtr:True,vitr:True,dbil:False,rmgx:True,rpth:0,hqsc:True,hqlp:False,tesm:0,blpr:1,bsrc:3,bdst:7,culm:0,dpts:2,wrdp:True,dith:2,ufog:True,aust:False,igpj:True,qofs:0,qpre:3,rntp:2,fgom:False,fgoc:False,fgod:False,fgor:False,fgmd:0,fgcr:0,fgcg:0,fgcb:0,fgca:1,fgde:0.01,fgrn:0,fgrf:300,ofsf:0,ofsu:0,f2p0:False;n:type:ShaderForge.SFN_Final,id:1419,x:32926,y:32899,varname:node_1419,prsc:2|emission-9052-OUT,alpha-5940-OUT;n:type:ShaderForge.SFN_Color,id:5448,x:32481,y:32894,ptovrint:False,ptlb:tint,ptin:_tint,varname:_tint,prsc:2,glob:False,c1:1,c2:0.475862,c3:0,c4:1;n:type:ShaderForge.SFN_Multiply,id:9052,x:32724,y:32998,varname:node_9052,prsc:2|A-6667-OUT,B-5448-RGB,C-7605-OUT;n:type:ShaderForge.SFN_ValueProperty,id:6667,x:32486,y:32816,ptovrint:False,ptlb:glow,ptin:_glow,varname:_glow,prsc:2,glob:False,v1:7;n:type:ShaderForge.SFN_TexCoord,id:8745,x:32053,y:33016,varname:node_8745,prsc:2,uv:0;n:type:ShaderForge.SFN_ValueProperty,id:5616,x:32054,y:33191,ptovrint:False,ptlb:thinness,ptin:_thinness,varname:_thinness,prsc:2,glob:False,v1:16;n:type:ShaderForge.SFN_Add,id:5940,x:32722,y:33157,varname:node_5940,prsc:2|A-7605-OUT,B-3871-OUT;n:type:ShaderForge.SFN_Slider,id:3871,x:32334,y:33241,ptovrint:False,ptlb:faceOpacity,ptin:_faceOpacity,varname:_faceOpacity,prsc:2,min:0,cur:0,max:1;n:type:ShaderForge.SFN_Code,id:7605,x:32301,y:33066,varname:node_7605,prsc:2,code:dQB2ACAAPQAgAHAAbwB3ACgAYQBiAHMAKAAoAHUAdgAgACoAIAAyACkAIAAtACAAMQApACwAIABwACkAOwAKAHIAZQB0AHUAcgBuACAAbQBhAHgAKAB1AHYALgB4ACwAIAB1AHYALgB5ACkAOwA=,output:0,fname:curveFunction,width:319,height:128,input:1,input:0,input_1_label:uv,input_2_label:p|A-8745-UVOUT,B-5616-OUT;proporder:5448-6667-5616-3871;pass:END;sub:END;*/
...
Shader "Aden/Tron" {
    ...
    SubShader {
        ...
        Pass {
            ...
            float curveFunction( float2 uv , float p ){
            uv = pow(abs((uv * 2) - 1), p);
...
////// Lighting:
////// Emissive:
                float node_7605 = curveFunction( i.uv0 , _thinness );
